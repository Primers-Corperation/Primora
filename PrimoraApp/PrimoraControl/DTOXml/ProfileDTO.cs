...
namespace Primora.PrimoraControl.DTOXml
{
    [XmlRoot("Primora")]
    public class ProfileDTO : IDTO<BackingStore>
    {
        ...
        public Primora.InputDevices.TriggerEffects L2TriggerEffect
        {
            get; set;
        }

        [XmlElement("R2TriggerEffect")]
        public Primora.InputDevices.TriggerEffects R2TriggerEffect
        {
            get; set;
        }
        ...
        [XmlElement("Control")]
        public PrimoraControlAssignementSerializer Control
        {
            get; set;
        }

        [XmlElement("ShiftControl")]
        public PrimoraControlAssignementSerializer ShiftControl
        {
            get; set;
        }
        ...
        public ProfileDTO()
        {
            ...
            Control = new PrimoraControlAssignementSerializer();
            ShiftControl = new PrimoraControlAssignementSerializer();
        }
        ...
        public void MapFrom(BackingStore source)
        {
            ...
            PrimoraControlButtonAssignmentSerializer buttonSerializer = new PrimoraControlButtonAssignmentSerializer();
            PrimoraControlKeyAssignmentSerializer keySerializer = new PrimoraControlKeyAssignmentSerializer();
            PrimoraControlKeyTypeAssignmentSerializer keyTypeSerializer = new PrimoraControlKeyTypeAssignmentSerializer();
            PrimoraControlMacroAssignmentSerializer macroSerializer = new PrimoraControlMacroAssignmentSerializer();
            PrimoraControlExtrasAssignmentSerializer extrasSerializer = new PrimoraControlExtrasAssignmentSerializer();
            PrimoraControlLightbarMacroAssignmentSerializer lightbarMacroSerializer = new();

            PrimoraControlButtonAssignmentSerializer shiftButtonSerializer = new PrimoraControlButtonAssignmentSerializer();
            PrimoraControlKeyAssignmentSerializer shiftKeySerializer = new PrimoraControlKeyAssignmentSerializer();
            PrimoraControlKeyTypeAssignmentSerializer shiftKeyTypeSerializer = new PrimoraControlKeyTypeAssignmentSerializer();
            PrimoraControlMacroAssignmentSerializer shiftMacroSerializer = new PrimoraControlMacroAssignmentSerializer();
            PrimoraControlExtrasAssignmentSerializer shiftExtrasSerializer = new PrimoraControlExtrasAssignmentSerializer();

            foreach (PrimoraControlSettings dcs in source.ds4settings[deviceIndex])
            {
                ...
                if (dcs.shiftActionType != PrimoraControlSettings.ActionType.Default && dcs.shiftTrigger > 0)
                {
                    ...
                    else if (dcs.shiftActionType == PrimoraControlSettings.ActionType.Macro)
                    {
        ...
        public void MapTo(BackingStore destination)
        {
            ...
            if (Control != null)
            {
                ...
                {
                    foreach(KeyValuePair<PrimoraControls, X360Controls> pair in Control.Button.CustomMapButtons)
                    {
                ...
                {
                    foreach(KeyValuePair<PrimoraControls, ushort> pair in Control.Key.CustomMapKeys)
                    {
                        destination.UpdateDS4CSetting(deviceIndex,
                            pair.Key.ToString(), false, pair.Value, "", DS4KeyType.None, 0);
                    }
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, string> pair in Control.Macro.CustomMapMacros)
                    {
                        string[] skeys;
                        int[] keys;
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, string> pair in Control.Extras.CustomMapExtras)
                    {
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, DS4KeyType> pair in Control.KeyType.CustomMapKeyTypes)
                    {
            ...
            if (ShiftControl != null)
            {
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, X360Controls> pair in ShiftControl.Button.CustomMapButtons)
                    {
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, ushort> pair in ShiftControl.Key.CustomMapKeys)
                    {
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, string> pair in ShiftControl.Macro.CustomMapMacros)
                    {
                        string[] skeys;
                        int[] keys;
                        if (!string.IsNullOrEmpty(pair.Value))
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, string> pair in ShiftControl.Extras.CustomMapExtras)
                    {
                        destination.UpdateDS4CExtra(deviceIndex,
                            pair.Key.ToString(), false, pair.Value);
                    }
                ...
                {
                    foreach (KeyValuePair<PrimoraControls, DS4KeyType> pair in ShiftControl.KeyType.CustomMapKeyTypes)
                    {
    ...
    public class PrimoraControlAssignementSerializer
    {
        [XmlElement("Button")]
        public PrimoraControlButtonAssignmentSerializer Button
        {
            get; set;
        }
        ...
        [XmlElement("Key")]
        public PrimoraControlKeyAssignmentSerializer Key
        {
            get; set;
        }
        ...
        [XmlElement("Macro")]
        public PrimoraControlMacroAssignmentSerializer Macro
        {
            get; set;
        }
        ...
        [XmlElement("Extras")]
        public PrimoraControlExtrasAssignmentSerializer Extras
        {
            get; set;
        }
        ...
        [XmlElement("KeyType")]
        public PrimoraControlKeyTypeAssignmentSerializer KeyType
        {
            get; set;
        }
        ...
        public PrimoraControlLightbarMacroAssignmentSerializer LightbarMacro
        {
            get; set;
        }
        ...
        public PrimoraControlAssignementSerializer()
        {
        }
    }

    public class PrimoraControlAssignmentSerializerBase
    {
        protected Dictionary<PrimoraControls, int> shiftTriggers =
            new Dictionary<PrimoraControls, int>();
        public Dictionary<PrimoraControls, int> ShiftTriggers => shiftTriggers;
    ...
    public class PrimoraControlButtonAssignmentSerializer : PrimoraControlAssignmentSerializerBase, IXmlSerializable
    {
        private Dictionary<PrimoraControls, X360Controls> customMapButtons
            = new Dictionary<PrimoraControls, X360Controls>();
        [XmlIgnore]
        public Dictionary<PrimoraControls, X360Controls> CustomMapButtons => customMapButtons;
            ...
            if (parentNode != null)
            {
                foreach (XmlNode item in parentNode.ChildNodes)
                {
                    if (Enum.TryParse(item.Name, out PrimoraControls currentControl))
                    {
                        ...
                        customMapButtons.Add(Global.getPrimoraControlsByName(item.Name),
        ...
        {
            foreach(KeyValuePair<PrimoraControls, X360Controls> pair in customMapButtons)
            {
    ...
    public class PrimoraControlKeyAssignmentSerializer : PrimoraControlAssignmentSerializerBase, IXmlSerializable
    {
        private Dictionary<PrimoraControls, ushort> customMapKeys
            = new Dictionary<PrimoraControls, ushort>();
        [XmlIgnore]
        public Dictionary<PrimoraControls, ushort> CustomMapKeys => customMapKeys;
            ...
            if (parentNode != null)
            {
                foreach (XmlNode item in parentNode.ChildNodes)
                {
                    if (ushort.TryParse(item.InnerText, out ushort wvk) &&
                        Enum.TryParse(item.Name, out PrimoraControls currentControl))
                    {
                        if (item.Attributes["Trigger"] != null)
                        {
                            int.TryParse(item.Attributes["Trigger"].Value, out int shiftT);
                        ...
                        customMapKeys.Add(Global.getPrimoraControlsByName(item.Name), wvk);
                    }
                }
            }
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            foreach (KeyValuePair<PrimoraControls, UInt16> pair in customMapKeys)
            {
                writer.WriteStartElement(pair.Key.ToString());
                if (shiftTriggers.TryGetValue(pair.Key, out int shiftTrigger) &&
                    shiftTrigger > 0)
    ...
    public class PrimoraControlMacroAssignmentSerializer : PrimoraControlAssignmentSerializerBase, IXmlSerializable
    {
        private Dictionary<PrimoraControls, string> customMapMacros
            = new Dictionary<PrimoraControls, string>();
        [XmlIgnore]
        public Dictionary<PrimoraControls, string> CustomMapMacros => customMapMacros;
            ...
            if (parentNode != null)
            {
                foreach (XmlNode item in parentNode.ChildNodes)
                {
                    if (Enum.TryParse(item.Name, out PrimoraControls currentControl))
                    {
                        ...
                        customMapMacros.Add(Global.getPrimoraControlsByName(item.Name), item.InnerText);
                    }
        ...
        public void WriteXml(XmlWriter writer)
        {
            foreach (KeyValuePair<PrimoraControls, string> pair in customMapMacros)
            {
                writer.WriteStartElement(pair.Key.ToString());
                if (shiftTriggers.TryGetValue(pair.Key, out int shiftTrigger) &&
                    shiftTrigger > 0)
    ...
    public class PrimoraControlKeyTypeAssignmentSerializer : PrimoraControlAssignmentSerializerBase, IXmlSerializable
    {
        private Dictionary<PrimoraControls, DS4KeyType> customMapKeyTypes
            = new Dictionary<PrimoraControls, DS4KeyType>();
        [XmlIgnore]
        public Dictionary<PrimoraControls, DS4KeyType> CustomMapKeyTypes => customMapKeyTypes;
                ...
                foreach (XmlNode item in parentNode.ChildNodes)
                {
                    if (item != null)
                    {
                            ...
                            Enum.TryParse(item.Name, out PrimoraControls currentControl))
                        {
                            ...
                            customMapKeyTypes.Add(Global.getPrimoraControlsByName(item.Name), keyType);
                        }
                    }
                }
            }
        ...
        public void WriteXml(XmlWriter writer)
        {
            foreach (KeyValuePair<PrimoraControls, DS4KeyType> pair in customMapKeyTypes)
            {
    ...
    public class PrimoraControlExtrasAssignmentSerializer : PrimoraControlAssignmentSerializerBase, IXmlSerializable
    {
        private Dictionary<PrimoraControls, string> customMapExtras
            = new Dictionary<PrimoraControls, string>();
        [XmlIgnore]
        public Dictionary<PrimoraControls, string> CustomMapExtras => customMapExtras;
            ...
            if (parentNode != null)
            {
                foreach (XmlNode item in parentNode.ChildNodes)
                {
                        ...
                        Enum.TryParse(item.Name, out PrimoraControls currentControl))
                    {
                        ...
                        customMapExtras.Add(Global.getPrimoraControlsByName(item.Name), item.InnerText);
                    }
                }
            }
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            foreach (KeyValuePair<PrimoraControls, string> pair in customMapExtras)
            {
                writer.WriteStartElement(pair.Key.ToString());
                if (shiftTriggers.TryGetValue(pair.Key, out int shiftTrigger) &&
                    shiftTrigger > 0)
    ...
    public class PrimoraControlLightbarMacroAssignmentSerializer : PrimoraControlAssignmentSerializerBase, IXmlSerializable
    {
        private Dictionary<PrimoraControls, string> customMapMacro
            = new Dictionary<PrimoraControls, string>();
        [XmlIgnore]
        public Dictionary<PrimoraControls, string> CustomMapMacro => customMapMacro;
            ...
            if (parentNode != null)
            {
                foreach (XmlNode item in parentNode.ChildNodes)
                {
                        ...
                        Enum.TryParse(item.Name, out PrimoraControls currentControl))
                    {
                        ...
                        customMapMacro.Add(Global.getPrimoraControlsByName(item.Name), item.InnerText);
                    }
                }
            }
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            foreach (KeyValuePair<PrimoraControls, string> pair in customMapMacro)
            {
                writer.WriteStartElement(pair.Key.ToString());
                if (shiftTriggers.TryGetValue(pair.Key, out int shiftTrigger) &&
                    shiftTrigger > 0)
