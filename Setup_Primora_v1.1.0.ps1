# Primora v1.1.0 — Liquid Glass Edition Installer
# (C) 2026 Primers Corperation

$appName = "Primora"
$appVersion = "1.1.0"
$installPath = "$env:LOCALAPPDATA\Primora"
$releaseFolder = "Release_v1.1.0_LiquidGlass"

Write-Host "----------------------------------------" -ForegroundColor Cyan
Write-Host "   Primora v1.1.0 - Liquid Glass   " -ForegroundColor White
...
Write-Host "[*] Registering Primora in system..."
$registryPath = "HKCU:\Software\Microsoft\Windows\CurrentVersion\Uninstall\Primora"
if (!(Test-Path $registryPath)) { New-Item -Path $registryPath -Force | Out-Null }
Set-ItemProperty -Path $registryPath -Name "DisplayName" -Value "Primora (Liquid Glass Edition)"
