...
namespace Primora
{
    ...
    public class DS4Device
    {
        ...
        private PrimoraControllerOptions nativeOptionsStore;
        ...
        public virtual void PostInit()
        {
            ...
            optionsStore = nativeOptionsStore = new PrimoraControllerOptions(deviceType);
            SetupOptionsEvents();
        ...
        private void sendOutputReport(bool synchronous, bool force = false, bool quitOutputThreadOnError = true)
        {
            ...
            // Some gamepads don't support lightbar and rumble, so no need to write out anything (writeOut always fails, so Primora would accidentally force quit the gamepad connection).
