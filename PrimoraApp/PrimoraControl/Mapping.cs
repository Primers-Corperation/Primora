...
namespace Primora
{
    public class Mapping
    {
        ...
        {
            public PrimoraControls ds4input;
            public PrimoraControls xoutput;

            public ControlToXInput(PrimoraControls input, PrimoraControls output)
            {
        ...
        private static PrimoraControls[] shiftTriggerMapping = new PrimoraControls[SHIFT_TRIGGER_MAPPING_LEN]
        {
            PrimoraControls.None, PrimoraControls.Cross, PrimoraControls.Circle, PrimoraControls.Square,
            PrimoraControls.Triangle, PrimoraControls.Options, PrimoraControls.Share, PrimoraControls.DpadUp, PrimoraControls.DpadDown,
            PrimoraControls.DpadLeft, PrimoraControls.DpadRight, PrimoraControls.PS, PrimoraControls.L1, PrimoraControls.R1, PrimoraControls.L2,
            PrimoraControls.R2, PrimoraControls.L3, PrimoraControls.R3, PrimoraControls.TouchLeft, PrimoraControls.TouchUpper, PrimoraControls.TouchMulti,
            PrimoraControls.TouchRight, PrimoraControls.GyroZNeg, PrimoraControls.GyroZPos, PrimoraControls.GyroXPos, PrimoraControls.GyroXNeg,
            PrimoraControls.None, PrimoraControls.Mute, PrimoraControls.FnL, PrimoraControls.FnR, PrimoraControls.BLP, PrimoraControls.BRP,
            PrimoraControls.Capture, PrimoraControls.SideL, PrimoraControls.SideR
        };

        /// <summary>
        /// Touch 1 Finger is treated special when it comes to shift triggers. It does not correspond
        /// to a direct value from PrimoraControls
        /// </summary>
        ...
        // is needed. This was originally made to replace a switch test used in the PrimoraControlToInt method.
        // PrimoraControls -> Macro input map index
        private static int[] PrimoraControlMapping = new int[DS4_CONTROL_MACRO_ARRAY_LEN]
        {
            0, // PrimoraControls.None
            16, // PrimoraControls.LXNeg
            20, // PrimoraControls.LXPos
            17, // PrimoraControls.LYNeg
            21, // PrimoraControls.LYPos
            18, // PrimoraControls.RXNeg
            22, // PrimoraControls.RXPos
            19, // PrimoraControls.RYNeg
            23, // PrimoraControls.RYPos
            3,  // PrimoraControls.L1
            24, // PrimoraControls.L2
            5,  // PrimoraControls.L3
            4,  // PrimoraControls.R1
            25, // PrimoraControls.R2
            6,  // PrimoraControls.R3
            13, // PrimoraControls.Square
            14, // PrimoraControls.Triangle
            15, // PrimoraControls.Circle
            12, // PrimoraControls.Cross
            7,  // PrimoraControls.DpadUp
            10, // PrimoraControls.DpadRight
            8,  // PrimoraControls.DpadDown
            9,  // PrimoraControls.DpadLeft
            11, // PrimoraControls.PS
            27, // PrimoraControls.TouchLeft
            29, // PrimoraControls.TouchUpper
            26, // PrimoraControls.TouchMulti
            28, // PrimoraControls.TouchRight
            1,  // PrimoraControls.Share
            2,  // PrimoraControls.Options
            30, // PrimoraControls.Mute
            32, // PrimoraControls.GyroXPos
            31, // PrimoraControls.GyroXNeg
            34, // PrimoraControls.GyroZPos
            33, // PrimoraControls.GyroZNeg
            35, // PrimoraControls.SwipeLeft
            36, // PrimoraControls.SwipeRight
            37, // PrimoraControls.SwipeUp
            38, // PrimoraControls.SwipeDown
            39, // PrimoraControls.L2FullPull
            40, // PrimoraControls.R2FullPull
            41, // PrimoraControls.GyroSwipeLeft
            42, // PrimoraControls.GyroSwipeRight
            43, // PrimoraControls.GyroSwipeUp
            44, // PrimoraControls.GyroSwipeDown
            45, // PrimoraControls.Capture
            46, // PrimoraControls.SideL
            47, // PrimoraControls.SideR
            48, // PrimoraControls.FnL
            49, // PrimoraControls.FnR
            50, // PrimoraControls.BLP
            51, // PrimoraControls.BRP
        };
        ...
        public static int PrimoraControltoInt(PrimoraControls ctrl)
        {
            int result = 0;
            if (ctrl >= PrimoraControls.None && ctrl <= PrimoraControls.SideR)
            {
                result = PrimoraControlMapping[(int)ctrl];
            }
        ...
        private static bool ShiftTrigger(int trigger, int device, DS4State cState, DS4StateExposed eState, Mouse tp, DS4StateFieldMapping fieldMapping)
        {
            ...
            {
                PrimoraControls ds = shiftTriggerMapping[trigger];
                result = GetBoolMapping(device, ds, cState, eState, tp, fieldMapping);
            }
            // 26 is a special case. It does not correlate to a direct PrimoraControls value
        ...
        /// </summary>
        static PrimoraControls[] held = new PrimoraControls[Global.MAX_DS4_CONTROLLER_COUNT];
        ...
        */
            ...
            Mouse tp, ControlService ctrl)
        {
            ...
            //if (ctrl.PrimoraControllers[device] == null) return;

            //cState.CopyTo(MappedState);

            //Dictionary<PrimoraControls, PrimoraControls> tempControlDict = new Dictionary<PrimoraControls, PrimoraControls>();
            //MultiValueDict<PrimoraControls, PrimoraControls> tempControlDict = new MultiValueDict<PrimoraControls, PrimoraControls>();

            //List<PrimoraControlSettings> tempSettingsList = getDS4CSettings(device);
            //foreach (PrimoraControlSettings dcs in getDS4CSettings(device))
            ...
            if (stickSettings.mode == StickMode.Controls)
            {
                ...
                {
                    PrimoraControlSettings dcs = settingEnum.Current;
            ...
            {
                outputfieldMapping.axisdirs[(int)PrimoraControls.LXNeg] = 128;
                outputfieldMapping.axisdirs[(int)PrimoraControls.LXPos] = 128;
                outputfieldMapping.axisdirs[(int)PrimoraControls.LYNeg] = 128;
                outputfieldMapping.axisdirs[(int)PrimoraControls.LYPos] = 128;
                ...
                switch (stickSettings.mode)
                {
                    ...
                    case StickMode.FlickStick:
                        DS4Device d = ctrl.PrimoraControllers[device];
            ...
            {
                outputfieldMapping.axisdirs[(int)PrimoraControls.RXNeg] = 128;
                outputfieldMapping.axisdirs[(int)PrimoraControls.RXPos] = 128;
                outputfieldMapping.axisdirs[(int)PrimoraControls.RYNeg] = 128;
                outputfieldMapping.axisdirs[(int)PrimoraControls.RYPos] = 128;
            ...
            PrimoraControlSettings dcsTemp = controlSetGroup.L2;
            ...
            {
                PrimoraControlSettings l2FullPull = controlSetGroup.L2FullPull;
                ...
                ProcessTwoStageTrigger(device, cState, cState.L2, cState.L2Raw, ref dcsTemp, ref l2FullPull,
                    l2TriggerSettings, l2TwoStageData, out PrimoraControlSettings outputSoftPull, out PrimoraControlSettings outputFullPull);
                    ...
                    (l2TwoStageData.previousActiveButtons & TwoStageTriggerMappingData.ActiveZoneButtons.SoftPull) != 0)
                {
                    ...
                    else
                    {
                        ...
                        fieldMapping.triggers[(int)PrimoraControls.L2] = 0;
                        outputfieldMapping.triggers[(int)PrimoraControls.L2] = 0;
                    }
                    ...
                    (l2TwoStageData.previousActiveButtons & TwoStageTriggerMappingData.ActiveZoneButtons.FullPull) != 0)
                {
                    ...
                    else
                    {
                        // Need to reset input state so output binding is not activated.
                        // Used to de-activate Extras
                        fieldMapping.buttons[(int)PrimoraControls.L2FullPull] = false;
                    }
            ...
            {
                PrimoraControlSettings r2FullPull = controlSetGroup.R2FullPull;
                ...
                ProcessTwoStageTrigger(device, cState, cState.R2, cState.R2Raw, ref dcsTemp, ref r2FullPull,
                    r2TriggerSettings, r2TwoStageData, out PrimoraControlSettings outputSoftPull, out PrimoraControlSettings outputFullPull);
                    ...
                    (r2TwoStageData.previousActiveButtons & TwoStageTriggerMappingData.ActiveZoneButtons.SoftPull) != 0)
                {
                    ...
                    else
                    {
                        // Need to reset input state so output binding is not activated.
                        // Used to de-activate Extras
                        fieldMapping.triggers[(int)PrimoraControls.R2] = 0;
                        outputfieldMapping.triggers[(int)PrimoraControls.R2] = 0;
                    }
                    ...
                    (r2TwoStageData.previousActiveButtons & TwoStageTriggerMappingData.ActiveZoneButtons.FullPull) != 0)
                {
                    ...
                    else
                    {
                        // Need to reset input state so output binding is not activated.
                        // Used to de-activate Extras
                        fieldMapping.buttons[(int)PrimoraControls.R2FullPull] = false;
                    }
            ...
            {
                PrimoraControlSettings gyroSwipeXDcs = null;
                PrimoraControlSettings gyroSwipeYDcs = null;
                PrimoraControlSettings previousGyroSwipeXDcs = null;
                PrimoraControlSettings previousGyroSwipeYDcs = null;
            ...
            unchecked
            {
                ...
                //while(tempControl.Any())
                {
                    ...
                    if (tempMap.xoutput >= PrimoraControls.LXNeg && tempMap.xoutput <= PrimoraControls.RYPos)
                    {
                    ...
                    {
                        if (tempMap.xoutput == PrimoraControls.L2 || tempMap.xoutput == PrimoraControls.R2)
                        {
        ...
        private static void ProcessTwoStageTrigger(int device, DS4State cState, byte triggerValue, byte triggerRawValue,
            ref PrimoraControlSettings inputSoftPull, ref PrimoraControlSettings inputFullPull, TriggerOutputSettings outputSettings,
            TwoStageTriggerMappingData twoStageData, out PrimoraControlSettings outputSoftPull, out PrimoraControlSettings outputFullPull)
        {
            PrimoraControlSettings dcsTemp = inputSoftPull;
            PrimoraControlSettings dcsFullPull = null;
        ...
        // array of PrimoraControls that can be mapped to a bool (through DS4State) and used for lightbar macro press/release function
        private static PrimoraControls[] BoolPrimoraControls =
        [
            PrimoraControls.Square, PrimoraControls.Triangle, PrimoraControls.Circle, PrimoraControls.Cross, PrimoraControls.DpadUp,
            PrimoraControls.DpadDown, PrimoraControls.DpadLeft, PrimoraControls.DpadRight, PrimoraControls.L1, PrimoraControls.L3,
            PrimoraControls.R1, PrimoraControls.R3, PrimoraControls.Share, PrimoraControls.Options, PrimoraControls.Mute,
            PrimoraControls.TouchRight, PrimoraControls.TouchLeft, PrimoraControls.Capture, PrimoraControls.SideL, PrimoraControls.SideR,
            PrimoraControls.FnL, PrimoraControls.FnR, PrimoraControls.BLP, PrimoraControls.BRP
        ];
        ...
        private static void ProcessControlSettingAction(PrimoraControlSettings dcs, int device, DS4State cState, DS4State MappedState, DS4StateExposed eState,
        ...
        {
            //PrimoraControlSettings dcs = tempSettingsList[settingIndex];

            uint actionAlias = 0;

            //object action = null;
            ControlActionData action = null;
            PrimoraControlSettings.ActionType actionType = 0;
            DS4KeyType keyType = DS4KeyType.None;
            PrimoraControls usingExtra = PrimoraControls.None;
            if (dcs.shiftActionType != PrimoraControlSettings.ActionType.Default && ShiftTrigger(dcs.shiftTrigger, device, cState, eState, tp, fieldMapping))
            {
            ...
            else if (dcs.actionType != PrimoraControlSettings.ActionType.Default)
            {
                action = dcs.action;
            ...
            if (usingExtra == PrimoraControls.None || usingExtra == dcs.control)
            {
                ...
                else if ((regE || shiftE) && held[device] == dcs.control)
                {
                    ...
                    held[device] = PrimoraControls.None;
                    usingExtra = PrimoraControls.None;
                }
            }
            ...
            {
                if (BoolPrimoraControls.Contains(dcs.control))
                {
                    var dev = ctrl.PrimoraControllers[device];
            ...
            {
                if (actionType == PrimoraControlSettings.ActionType.Macro)
                {
                ...
                else if (actionType == PrimoraControlSettings.ActionType.Key)
                {
                ...
                else if (actionType == PrimoraControlSettings.ActionType.Button)
                {
                    ...
                    if (dcs.control >= PrimoraControls.LXNeg && dcs.control <= PrimoraControls.RYPos)
                    {
                        isAnalog = true;
                    }
                    else if (dcs.control == PrimoraControls.L2 || dcs.control == PrimoraControls.R2)
                    {
                        isAnalog = true;
                    }
                    else if (dcs.control >= PrimoraControls.GyroXPos && dcs.control <= PrimoraControls.GyroZNeg)
                    {
                        isAnalog = true;
                    }
                    ...
                    {
                        PrimoraControls tempPrimoraControl = reverseX360ButtonMapping[(int)xboxControl];
                        customMapQueue[device].Enqueue(new ControlToXInput(dcs.control, tempPrimoraControl));
                        //tempControlDict.Add(dcs.control, tempPrimoraControl);
                    }
            ...
            else
            {
                ...
                //if (dcs.control > PrimoraControls.None && dcs.control < PrimoraControls.L1)
                {
        ...
        private static bool IfAxisIsNotModified(int device, bool shift, PrimoraControls dc)
        {
            return shift ? false : GetDS4CSetting(device, dc).actionType == PrimoraControlSettings.ActionType.Default;
        }
                     ...
                     actionIndex < profileListLen; actionIndex++)
                {
                    ...
                    if (!(action.typeID == SpecialAction.ActionTypeId.None || index < 0))
                    {
                        ...
                        if (action.delayTime > 0.0)
                        {
                            ...
                            //foreach (PrimoraControls dc in action.trigger)
                            for (int i = 0, arlen = action.trigger.Count; i < arlen; i++)
                            {
                                PrimoraControls dc = action.trigger[i];
                        ...
                        {
                            //foreach (PrimoraControls dc in action.uTrigger)
                            for (int i = 0, arlen = action.uTrigger.Count; i < arlen; i++)
                            {
                                PrimoraControls dc = action.uTrigger[i];
                                if (!getBoolSpecialActionMapping(device, dc, cState, eState, tp, fieldMapping))
                                {
                        ...
                        if (triggeractivated)
                        {
                            ...
                            else if (action.typeID == SpecialAction.ActionTypeId.Profile)
                            {
                                ...
                                if (!actionDone[index].dev[device] && (!useTempProfile[device] || untriggeraction[device] == null || untriggeraction[device].typeID != SpecialAction.ActionTypeId.Profile))
                                {
                                    ...
                                    DS4Device d = ctrl.PrimoraControllers[device];
                                    string prolog = string.Format(Primora.Properties.Resources.UsingProfile,
                                ...
                                if (!action.pressRelease)
                                {
                                    ...
                                    if (!actionDone[index].dev[device])
                                    {
                                        ...
                                        */
                                        ...
                                        PlayMacro(device, macroControl, String.Empty, action.macro, null, PrimoraControls.None, keyType, action, actionDone[index]);
                                    }
                                    else
                                    {
                                        if (!action.keyType.HasFlag(DS4KeyType.RepeatMacro))
                                            EndMacro(device, macroControl, action.macro, PrimoraControls.None);
                                    }
                                }
                                else
                                {
                                    ...
                                    if (action.firstTouch)
                                    {
                                        ...
                                        if (!actionDone[index].dev[device])
                                        {
                                            ...
                                            */
                                            ...
                                            PlayMacro(device, macroControl, String.Empty, action.macro, null, PrimoraControls.None, keyType, action, null);
                                        }
                                    }
                                    else
                            ...
                            else if (action.typeID == SpecialAction.ActionTypeId.GyroCalibrate)
                            {
                                ...
                                if (!actionDone[index].dev[device])
                                {
                                    var d = ctrl.PrimoraControllers[device];

                                    d.SixAxis.ResetContinuousCalibration();
                                    if (d.JointDeviceSlotNumber != DS4Device.DEFAULT_JOINT_SLOT_NUMBER)
                                    {
                                        DS4Device tempDev = ctrl.PrimoraControllers[d.JointDeviceSlotNumber];
                        ...
                        if (!actionFound)
                        {
                            ...
                            else if (action.typeID == SpecialAction.ActionTypeId.XboxGameDVR || action.typeID == SpecialAction.ActionTypeId.MultiAction)
                            {
                                ...
                                if (tappedOnce) //single tap
                                {
                                    ...
                                    {
                                        if (macro != "")
                                            PlayMacro(device, macroControl, macro, null, null, PrimoraControls.None, DS4KeyType.None);
        ...
        private static void PlayMacro(int device, bool[] macrocontrol, string macroStr, List<int> macroLst, int[] macroArr, PrimoraControls control, DS4KeyType keyType, SpecialAction action = null, ActionState actionDoneState = null)
        {
        ...
        private static void PlayMacroTask(int device, bool[] macrocontrol, string macroStr, List<int> macroLst, int[] macroArr, PrimoraControls control, DS4KeyType keyType, SpecialAction action, ActionState actionDoneState)
        {
            ...
            )
            {
                ...
                if (control != PrimoraControls.None)
                    macrodone[PrimoraControltoInt(control)] = true;
            }
            else if (control == PrimoraControls.None || !macrodone[PrimoraControltoInt(control)])
            {
                int macroCodeValue;
                ...
                //Program.rootHub.PrimoraControllers[device].setRumble(0, 0);

                if (keyType.HasFlag(DS4KeyType.HoldMacro))
                {
                    Task.Delay(50).Wait();
                    if (control != PrimoraControls.None)
                        macrodone[PrimoraControltoInt(control)] = false;
                }
            }
        ...
        private static bool PlayMacroCodeValue(int device, bool[] macrocontrol, DS4KeyType keyType, int macroCodeValue, bool[] keydown)
        {
            ...
            if (macroCodeValue >= 261 && macroCodeValue <= PrimoraControlSettings.MAX_MACRO_VALUE)
            {
            ...
            {
                // Rumble event
                DS4Device d = Program.rootHub.PrimoraControllers[device];
        ...
        private static void EndMacro(int device, bool[] macrocontrol, string macro, PrimoraControls control)
        {
        ...
        private static void EndMacro(int device, bool[] macrocontrol, List<int> macro, PrimoraControls control)
        {
        ...
        private static void EndMacro(int device, bool[] macrocontrol, int[] macro, PrimoraControls control)
        {
        ...
        private static void GetMouseWheelMapping(int device, PrimoraControls control, DS4State cState,
        ...
        private static double GetAbsMouseMapping(int device, PrimoraControls control, DS4State cState, DS4StateExposed eState,
        ...
        private static double getMouseMapping(int device, PrimoraControls control, DS4State cState, DS4StateExposed eState,
            DS4StateFieldMapping fieldMapping, int mnum, ControlService ctrl)
        {
            ...
            int controlNum = (int)control;
            DS4StateFieldMapping.ControlType controlType = DS4StateFieldMapping.mappedType[controlNum];
            //long timeElapsed = ctrl.PrimoraControllers[device].getLastTimeElapsed();
            double timeElapsed = ctrl.PrimoraControllers[device].lastTimeElapsedDouble;
        ...
        /// <returns></returns>
        private static byte GetByteMapping(int device, PrimoraControls control, DS4State cState, DS4StateExposed eState, Mouse tp,
            DS4StateFieldMapping fieldMap)
        {
            ...
            else if (controlType == DS4StateFieldMapping.ControlType.AxisDir)
            {
                ...
                switch (control)
                {
                    case PrimoraControls.LXNeg: result = (byte)(axisValue - 128.0f >= 0 ? 0 : -(axisValue - 128.0f) * 1.9921875f); break;
                    case PrimoraControls.LYNeg: result = (byte)(axisValue - 128.0f >= 0 ? 0 : -(axisValue - 128.0f) * 1.9921875f); break;
                    case PrimoraControls.RXNeg: result = (byte)(axisValue - 128.0f >= 0 ? 0 : -(axisValue - 128.0f) * 1.9921875f); break;
                    case PrimoraControls.RYNeg: result = (byte)(axisValue - 128.0f >= 0 ? 0 : -(axisValue - 128.0f) * 1.9921875f); break;
        ...
        public static bool GetBoolMappingExternal(int device, PrimoraControls control,
            DS4State cState, DS4StateExposed eState, Mouse tp)
        {
            bool result = false;

            if (control >= PrimoraControls.Square && control <= PrimoraControls.Cross)
            {
                switch (control)
                {
                    case PrimoraControls.Cross: result = cState.Cross; break;
                    case PrimoraControls.Square: result = cState.Square; break;
                    case PrimoraControls.Triangle: result = cState.Triangle; break;
                    case PrimoraControls.Circle: result = cState.Circle; break;
                    default: break;
                }
            }
            else if (control >= PrimoraControls.L1 && control <= PrimoraControls.R3)
            {
                switch (control)
                {
                    case PrimoraControls.L1: result = cState.L1; break;
                    case PrimoraControls.R1: result = cState.R1; break;
                    case PrimoraControls.L2: result = cState.L2 > 100; break;
                    case PrimoraControls.R2: result = cState.R2 > 100; break;
                    case PrimoraControls.L3: result = cState.L3; break;
                    case PrimoraControls.R3: result = cState.R3; break;
                    default: break;
                }
            }
            else if (control >= PrimoraControls.DpadUp && control <= PrimoraControls.DpadLeft)
            {
                switch (control)
                {
                    case PrimoraControls.DpadUp: result = cState.DpadUp; break;
                    case PrimoraControls.DpadDown: result = cState.DpadDown; break;
                    case PrimoraControls.DpadLeft: result = cState.DpadLeft; break;
                    case PrimoraControls.DpadRight: result = cState.DpadRight; break;
                    default: break;
                }
            }
            else if (control >= PrimoraControls.LXNeg && control <= PrimoraControls.RYPos)
            {
                switch (control)
                {
                    case PrimoraControls.LXNeg: result = cState.LX < 128 - 55; break;
                    case PrimoraControls.LYNeg: result = cState.LY < 128 - 55; break;
                    case PrimoraControls.RXNeg: result = cState.RX < 128 - 55; break;
                    case PrimoraControls.RYNeg: result = cState.RY < 128 - 55; break;
                    case PrimoraControls.LXPos: result = cState.LX > 128 + 55; break;
                    case PrimoraControls.LYPos: result = cState.LY > 128 + 55; break;
                    case PrimoraControls.RXPos: result = cState.RX > 128 + 55; break;
                    case PrimoraControls.RYPos: result = cState.RY > 128 + 55; break;
                    default: break;
                }
            }
            else if (control >= PrimoraControls.TouchLeft && control <= PrimoraControls.TouchRight)
            {
                switch (control)
                {
                    case PrimoraControls.TouchLeft: result = (tp != null ? tp.leftDown : false); break;
                    case PrimoraControls.TouchRight: result = (tp != null ? tp.rightDown : false); break;
                    case PrimoraControls.TouchMulti: result = (tp != null ? tp.multiDown : false); break;
                    case PrimoraControls.TouchUpper: result = (tp != null ? tp.upperDown : false); break;
                    default: break;
                }
            }
            else if (control >= PrimoraControls.SwipeLeft && control <= PrimoraControls.SwipeDown)
            {
                switch (control)
                {
                    case PrimoraControls.SwipeUp: result = (tp != null && tp.swipeUp); break;
                    case PrimoraControls.SwipeDown: result = (tp != null && tp.swipeDown); break;
                    case PrimoraControls.SwipeLeft: result = (tp != null && tp.swipeLeft); break;
                    case PrimoraControls.SwipeRight: result = (tp != null && tp.swipeRight); break;
                    default: break;
                }
            }
            else if (control >= PrimoraControls.GyroXPos && control <= PrimoraControls.GyroZNeg)
            {
                bool saControls = IsUsingSAForControls(device);

                switch (control)
                {
                    case PrimoraControls.GyroXPos: result = saControls ? SXSens[device] * -eState.AccelX > 67 : false; break;
                    case PrimoraControls.GyroXNeg: result = saControls ? SXSens[device] * -eState.AccelX < -67 : false; break;
                    case PrimoraControls.GyroZPos: result = saControls ? SZSens[device] * eState.AccelZ > 67 : false; break;
                    case PrimoraControls.GyroZNeg: result = saControls ? SZSens[device] * eState.AccelZ < -67 : false; break;
                    default: break;
                }
            }
            else
            {
                switch (control)
                {
                    case PrimoraControls.PS: result = cState.PS; break;
                    case PrimoraControls.Share: result = cState.Share; break;
                    case PrimoraControls.Options: result = cState.Options; break;
                    default: break;
                }
            }
        ...
        private static bool GetBoolMapping(int device, PrimoraControls control,
            DS4State cState, DS4StateExposed eState, Mouse tp, DS4StateFieldMapping fieldMap)
        {
            ...
            else if (controlType == DS4StateFieldMapping.ControlType.GyroDir)
            {
                ...
                switch (control)
                {
                    case PrimoraControls.GyroXPos: safeTest = fieldMap.gryodirs[controlNum] > 0; break;
                    case PrimoraControls.GyroXNeg: safeTest = fieldMap.gryodirs[controlNum] < -0; break;
                    case PrimoraControls.GyroZPos: safeTest = fieldMap.gryodirs[controlNum] > 0; break;
                    case PrimoraControls.GyroZNeg: safeTest = fieldMap.gryodirs[controlNum] < -0; break;
                    default: break;
                }
        ...
        private static bool getBoolSpecialActionMapping(int device, PrimoraControls control,
            DS4State cState, DS4StateExposed eState, Mouse tp, DS4StateFieldMapping fieldMap)
        {
            bool result = false;
            ...
            else if (controlType == DS4StateFieldMapping.ControlType.GyroDir)
            {
                ...
                switch (control)
                {
                    case PrimoraControls.GyroXPos: safeTest = fieldMap.gryodirs[controlNum] > 67; break;
                    case PrimoraControls.GyroXNeg: safeTest = fieldMap.gryodirs[controlNum] < -67; break;
                    case PrimoraControls.GyroZPos: safeTest = fieldMap.gryodirs[controlNum] > 67; break;
                    case PrimoraControls.GyroZNeg: safeTest = fieldMap.gryodirs[controlNum] < -67; break;
                    default: break;
                }
        ...
        private static bool GetBoolActionMapping(int device, PrimoraControls control,
        ...
        /// <returns></returns>
        private static byte GetXYAxisMapping(int device, PrimoraControls control, DS4State cState,
            DS4StateExposed eState, Mouse tp, DS4StateFieldMapping fieldMap, bool alt = false)
        {
            ...
            else if (controlType == DS4StateFieldMapping.ControlType.AxisDir)
            {
                ...
                switch (control)
                {
                    case PrimoraControls.LXNeg: if (!alt) result = axisValue < falseVal ? axisValue : falseVal; else result = axisValue < falseVal ? (byte)(255 - axisValue) : falseVal; break;
                    case PrimoraControls.LYNeg: if (!alt) result = axisValue < falseVal ? axisValue : falseVal; else result = axisValue < falseVal ? (byte)(255 - axisValue) : falseVal; break;
                    case PrimoraControls.RXNeg: if (!alt) result = axisValue < falseVal ? axisValue : falseVal; else result = axisValue < falseVal ? (byte)(255 - axisValue) : falseVal; break;
                    case PrimoraControls.RYNeg: if (!alt) result = axisValue < falseVal ? axisValue : falseVal; else result = axisValue < falseVal ? (byte)(255 - axisValue) : falseVal; break;
        ...
        private static void ResetToDefaultValue(PrimoraControls control, DS4State cState,
            DS4StateFieldMapping fieldMap)
        {
            int controlNum = (int)control;
            DS4StateFieldMapping.ControlType controlType = DS4StateFieldMapping.mappedType[controlNum];
        ...
        // Calibrate sixaxis steering wheel emulation. Use Primora configuration screen to start a calibration or press a special action key (if defined)
        ...
        protected static Int32 Scale360degreeGyroAxis(int device, DS4StateExposed exposedState, ControlService ctrl)
        {
            unchecked
            {
                ...
                controller = ctrl.PrimoraControllers[device];
                ...
                if (controller.wheelCenterPoint.IsEmpty)
                {
                    ...
                    if (!Global.LoadControllerConfigs(controller) || controller.wheelCenterPoint.IsEmpty)
                    {
                        ...
                        // Use current controller position as "center point". Assume Primora was started while controller was hold in center position (yes, dangerous assumption but can't do much until controller is calibrated)
                        controller.wheelCenterPoint.X = gyroAccelX;
                        controller.wheelCenterPoint.Y = gyroAccelZ;
