...
namespace Primora.InputDevices
{
            ...
            */
            ...
            unchecked
            {
                ...
                while (!exitInputThread)
                {
                    ...
                    tempMotion.accelXG = (accelX * 2) / Primora.SixAxis.F_ACC_RES_PER_G;
                    tempMotion.accelYG = (-accelZ * 2) / Primora.SixAxis.F_ACC_RES_PER_G;
                    tempMotion.accelZG = (-accelY * 2) / Primora.SixAxis.F_ACC_RES_PER_G;
