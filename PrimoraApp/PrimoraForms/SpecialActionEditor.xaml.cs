...
using Primora.PrimoraForms.ViewModels.SpecialActions;
...
namespace Primora.PrimoraForms
{
    ...
    public partial class SpecialActionEditor : UserControl
    {
        ...
        public SpecialActionEditor(int deviceNum, ProfileList profileList,
            Primora.SpecialAction specialAction = null)
        {
            InitializeComponent();
        ...
        private void LoadAction(Primora.SpecialAction specialAction)
        {
            ...
            {
                case Primora.SpecialAction.ActionTypeId.Macro:
                    macroActVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.Program:
                    launchProgVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.Profile:
                    loadProfileVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.Key:
                    pressKeyVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.DisconnectBT:
                    disconnectBtVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.BatteryCheck:
                    checkBatteryVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.MultiAction:
                    multiActButtonVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.SASteeringWheelEmulationCalibrate:
                    saSteeringWheelVM.LoadAction(specialAction);
                    break;
                case Primora.SpecialAction.ActionTypeId.GyroCalibrate:
        ...
        {
            Primora.SpecialAction.ActionTypeId typeId = specialActVM.TypeAssoc[specialActVM.ActionTypeIndex];
            Primora.SpecialAction tempAct = new Primora.SpecialAction("null", "null", "null", "null");
            ...
            if (valid)
            {
                ...
                {
                    Primora.Global.RemoveAction(specialActVM.SavedAction.name);
                    editMode = false;
                }
        ...
        private bool CheckActionValid(Primora.SpecialAction action,
            Primora.SpecialAction.ActionTypeId typeId)
        {
            bool valid = false;
            switch (typeId)
            {
        ...
        {
            Primora.PrimoraControlSettings settings = macroActVM.PrepareSettings();
        ...
        {
            Primora.PrimoraControlSettings settings = multiActButtonVM.PrepareTapSettings();
        ...
        {
            Primora.PrimoraControlSettings settings = multiActButtonVM.PrepareHoldSettings();
            RecordBoxWindow recordWin = new RecordBoxWindow(specialActVM.DeviceNum, settings, false);
            recordWin.Saved += (sender2, args) =>
            {
        ...
        {
            Primora.PrimoraControlSettings settings = multiActButtonVM.PrepareDoubleTapSettings();
            RecordBoxWindow recordWin = new RecordBoxWindow(specialActVM.DeviceNum, settings, false);
            recordWin.Saved += (sender2, args) =>
            {
        ...
        {
            Primora.PrimoraControlSettings settings = pressKeyVM.PrepareSettings();
