...
namespace Primora.PrimoraForms.ViewModels
{
    public class MainWindowsViewModel
    {
        ...
        public bool RunUpdaterCheck(bool launch, out string upstreamVersion)
        {
            ...
            {
                launch = false;
                Uri url2 = new Uri($"https://github.com/PrimersCorporation/DS4Updater/releases/download/v{upstreamVersion}/{updaterExe}");
                ...
                if (launch)
                {
                    ...
                    {
                        int copyStatus = Primora.Util.ElevatedCopyUpdater(filename);
        ...
        {
            return Primora.Util.IsNet8DesktopRuntimeAvailable();
        }
    }
}
