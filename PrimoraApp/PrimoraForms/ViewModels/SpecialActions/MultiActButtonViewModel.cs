...
namespace Primora.PrimoraForms.ViewModels.SpecialActions
{
    public class MultiActButtonViewModel : NotifyDataErrorBase
    {
        ...
        public PrimoraControlSettings PrepareTapSettings()
        {
            PrimoraControlSettings settings = new PrimoraControlSettings(PrimoraControls.None);
        ...
        public PrimoraControlSettings PrepareHoldSettings()
        {
            PrimoraControlSettings settings = new PrimoraControlSettings(PrimoraControls.None);
        ...
        public PrimoraControlSettings PrepareDoubleTapSettings()
        {
            PrimoraControlSettings settings = new PrimoraControlSettings(PrimoraControls.None);
