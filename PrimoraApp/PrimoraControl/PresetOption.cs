...
namespace Primora.PrimoraControl
{
    ...
    public class GamepadPreset : PresetOption
    {
        ...
        public override void ApplyPreset(int idx)
        {
            ...
            {
                Primora.Global.LoadBlankDevProfile(idx, false, App.rootHub, false);
            }
            else if (outputCont == OutputContChoice.DualShock4)
            {
                Primora.Global.LoadBlankDS4Profile(idx, false, App.rootHub, false);
            }
        }
    }
    ...
    public class GamepadGyroCamera : PresetOption
    {
        ...
        public override void ApplyPreset(int idx)
        {
            if (outputCont == OutputContChoice.Xbox360)
            {
                Primora.Global.LoadDefaultGamepadGyroProfile(idx, false, App.rootHub, false);
            }
            else if (outputCont == OutputContChoice.DualShock4)
            {
                Primora.Global.LoadDefaultDS4GamepadGyroProfile(idx, false, App.rootHub, false);
            }
        }
    }
    ...
    public class MixedPreset : PresetOption
    {
        ...
        public override void ApplyPreset(int idx)
        {
            if (outputCont == OutputContChoice.Xbox360)
            {
                Primora.Global.LoadDefaultMixedControlsProfile(idx, false, App.rootHub, false);
            }
            else if (outputCont == OutputContChoice.DualShock4)
            {
                Primora.Global.LoadDefaultDS4MixedControlsProfile(idx, false, App.rootHub, false);
            }
        }
    }
    ...
    public class MixedGyroMousePreset : PresetOption
    {
        ...
        public override void ApplyPreset(int idx)
        {
            if (outputCont == OutputContChoice.Xbox360)
            {
                Primora.Global.LoadDefaultMixedGyroMouseProfile(idx, false, App.rootHub, false);
            }
            else if (outputCont == OutputContChoice.DualShock4)
            {
                Primora.Global.LoadDefaultDS4MixedGyroMouseProfile(idx, false, App.rootHub, false);
            }
        }
    }
    ...
    public class KBMPreset : PresetOption
    {
        ...
        public override void ApplyPreset(int idx)
        {
            Primora.Global.LoadDefaultKBMProfile(idx, false, App.rootHub, false);
        }
    }
    ...
    public class KBMGyroMouse : PresetOption
    {
        ...
        public override void ApplyPreset(int idx)
        {
            Primora.Global.LoadDefaultKBMGyroMouseProfile(idx, false, App.rootHub, false);
        }
    }
}
