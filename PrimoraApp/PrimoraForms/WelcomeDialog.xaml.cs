...
namespace Primora.PrimoraForms
{
    ...
    public partial class WelcomeDialog : Window
    {
        ...
        private const string InstallerFakerInputX64 = "https://github.com/PrimersCorporation/FakerInput/releases/download/v0.1.0/FakerInput_0.1.0_x64.msi";
        private const string InstallerFakerInputX86 = "https://github.com/PrimersCorporation/FakerInput/releases/download/v0.1.0/FakerInput_0.1.0_x86.msi";
        ...
        public WelcomeDialog(bool loadConfig = false)
        {
            if (loadConfig)
            {
                ...
                Primora.Global.Load();
                //Primora.Global.SetCulture(Primora.Global.UseLang);
            }
            ...
            if (!Primora.Global.IsWin10OrGreater())
            {
            ...
            if (Primora.Global.IsWin8OrGreater())
            {
        ...
        {
            // HidHide requires Windows 10 (or later) x64
            return Primora.Global.IsWin10OrGreater() &&
        ...
        private bool IsFakerInputControlCompatible()
        {
            ...
            return Primora.Global.IsWin8OrGreater();
        }
        ...
        private void ViGEmInstallTimer_Tick(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            if (monitorProc != null && monitorProc.HasExited)
            {
                ...
                if (Primora.Global.IsViGEmBusInstalled())
                {
            ...
            System.Timers.ElapsedEventArgs e)
        {
            ...
            if (monitorProc != null && monitorProc.HasExited)
            {
                if (Primora.Global.IsHidHideInstalled())
                {
                    Dispatcher.BeginInvoke((Action)(() =>
                    {
            ...
            System.Timers.ElapsedEventArgs e)
        {
            ...
            if (monitorProc != null && monitorProc.HasExited)
            {
                if (Primora.Global.IsFakerInputInstalled())
                {
                    Dispatcher.BeginInvoke((Action)(() =>
                    {
    ...
    {
        public string PairmodePNG { get => $"{Primora.Global.RESOURCES_PREFIX}/Pairmode.png"; }
    }
}
