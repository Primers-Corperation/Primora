...
using LEDBarMode = Primora.DualSenseControllerOptions.LEDBarMode;
using MuteLEDMode = Primora.DualSenseControllerOptions.MuteLEDMode;
using LinkMode = Primora.JoyConDeviceOptions.LinkMode;
using JoinedGyroProvider = Primora.JoyConDeviceOptions.JoinedGyroProvider;
...
namespace Primora.PrimoraForms.ViewModels
{
    public class ControllerRegDeviceOptsViewModel
    {
        ...
        public PrimoraControllerOptions CurrentDS4Options
        {
            get => controllerOptionsStores[controllerSelectedIndex] as PrimoraControllerOptions;
        }
            ...
            ControlService service)
        {
            ...
            int idx = 0;
            foreach(DS4Device device in service.PrimoraControllers)
            {
                if (device != null)
                {
        ...
        public int FindTabOptionsIndex()
        {
            ...
            {
                case Primora.InputDevices.InputDeviceType.DS3:
                    result = 0;
                    break;
                case Primora.InputDevices.InputDeviceType.DS4:
                    result = 1;
                    break;
                case Primora.InputDevices.InputDeviceType.DualSense:
                    result = 2;
                    break;
                case Primora.InputDevices.InputDeviceType.SwitchPro:
                    result = 3;
                    break;
                case Primora.InputDevices.InputDeviceType.JoyConL:
                case Primora.InputDevices.InputDeviceType.JoyConR:
                    result = 4;
                    break;
                default:
        ...
        public void FindFittingDataContext()
        {
            ...
            switch (currentStore.DeviceType)
            {
                case Primora.InputDevices.InputDeviceType.DS3:
                    ...
                    break;
                case Primora.InputDevices.InputDeviceType.DS4:
                    dataContextObject = new PrimoraControllerOptionsWrapper(CurrentDS4Options, serviceDeviceOpts.DS4DeviceOpts);
                    break;
                case Primora.InputDevices.InputDeviceType.DualSense:
    ...
    public class PrimoraControllerOptionsWrapper
    {
        private PrimoraControllerOptions options;
        public PrimoraControllerOptions Options { get => options; }
        ...
        public PrimoraControllerOptionsWrapper(PrimoraControllerOptions options, DS4DeviceOptions parentOpts)
        {
